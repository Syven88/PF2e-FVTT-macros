...
new Sequence("Bless")
    ...
    .effect()
        ...
        .origin("blessAnim") //adds a tag to the animation for reference by the increment macro
        .name("Bless") //adds a name so it can be easily identified in the effects manager
