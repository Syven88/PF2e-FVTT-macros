...
let baneAnim = Sequencer.EffectManager.getEffects({origin:"baneAnim",token:caster})[0] //locates the bane animation created by bane_Animation
...
if (Sequencer.EffectManager.getEffects({origin:"baneAnim",token:caster})[0] === undefined){
